...
class MakeMigrations implements Makeable
{
	protected $formattedSource;
	protected $classArray;
	public $contentsToWrite;
	...
	public function __construct(FetchSourceFiles $fetch, $config = null)
	{
		$this->fetch = $fetch->formattedSource;
		$this->config = $config;
		$this->makeMigrations();
	}
